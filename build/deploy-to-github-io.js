...
const CURRENT_PROJECT_DIST_PATH = path.resolve(CURRENT_PROJECT_PATH, './dist');
const GITHUB_PAGES_PROJECT_PATH = path.resolve(CURRENT_PROJECT_PATH, '../forwardNow.github.io/flowchart-editor');
const BUILD_CMD = 'npm run build:test';
